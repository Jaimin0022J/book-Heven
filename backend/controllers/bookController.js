...
let mockBooks = [
  ...
  { _id: '9', title: 'Principles', author: 'Ray Dalio', genre: 'Business', price: 1499, rentalPrice: 120, stockCount: 7, imageURL: 'https://images.unsplash.com/photo-1507679799987-c7377ec48696?auto=format&fit=crop&q=80&w=800', listingType: 'Sale', seller: null, rating: 4.7, numReviews: 14, reviews: [] },
  { _id: '10', title: 'Sapiens', author: 'Yuval Noah Harari', genre: 'History', price: 449, rentalPrice: 35, stockCount: 18, imageURL: 'https://images.unsplash.com/photo-1447069387593-a5de0862081e?auto=format&fit=crop&q=80&w=800', listingType: 'Both', seller: null, rating: 4.8, numReviews: 35, reviews: [] },
...
module.exports = { getBooks, getBookById, createBook, updateBook, deleteBook, createBookReview, updateBookReview, deleteBookReview };
